# Block hardness with minecraft namespace
TOOL_SPEEDS = {
    "minecraft:stone_pickaxe":      [4, 6, 9, 14, 21, 30],
    "minecraft:copper_pickaxe":     [5, 7, 10, 15, 22, 31],
    "minecraft:iron_pickaxe":       [6, 8, 11, 16, 23, 32],
    "minecraft:diamond_pickaxe":    [8, 10, 13, 18, 25, 34],
    "minecraft:netherite_pickaxe":  [9, 11, 14, 19, 26, 35],
    "minecraft:golden_pickaxe":     [12, 14, 17, 22, 29, 38],
}
BLOCK_HARDNESS = {
    # Stone variants
    'minecraft:stone': 1.5,
    ...
    'minecraft:deepslate_potato_ore': 4.5,  # potato variant

    # Potato ores (modded/funny ones)
    'minecraft:potone_copper_ore': 4.5,
    'minecraft:potone_iron_ore': 4.5,
    'minecraft:potone_gold_ore': 4.5,
    'minecraft:potone_redstone_ore': 4.5,
    'minecraft:potone_diamond_ore': 4.5,
    'minecraft:potone_lapis_ore': 4.5,

    # Special underground blocks
